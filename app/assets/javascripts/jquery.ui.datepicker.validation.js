...
if ($.fn.validate) {
	...
	$.extend($.datepicker.regional[''], {
		...
		validateDateMin: 'Ingrese una fecha despues de {0}',
		validateDateMax: 'Ingrese una fecha antes de {0}',
		validateDateMinMax: 'Ingrese una fecha entre {0} y {1}',
		validateDateCompare: 'Ingrese una fecha {0} {1}',
		validateDateToday: 'Hoy',
		validateDateOther: 'El otro dia',
		validateDateEQ: 'Igual a',
		validateDateNE: 'Diferente a',
		validateDateLT: 'Antes',
		validateDateGT: 'Despues',
		validateDateLE: 'Antes',
		validateDateGE: 'Despues'
	});
