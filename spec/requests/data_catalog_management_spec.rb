...
feature 'data catalog management' do
  ...
  scenario 'catalog will have correct DCAT key names' do
    ...
    dcat_dataset_keys = %w(identifier title description keyword modified contactPoint spatial landingPage language publisher distribution accrualPeriodicity govType theme)
