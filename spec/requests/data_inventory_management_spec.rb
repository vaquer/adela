...
feature 'data inventory management' do
  ...
  scenario 'catalog will have correct DCAT key names' do
    ...
    dcat_dataset_keys = %w(id title description issued modified identifier keyword language contactPoint temporal spatial accrualPeriodicity landingPage publisher public publishDate distribution openessRating)
